<template>
        <el-dialog title="提现" custom-class="login-dialog" :visible.sync="dialogFormVisible">
        <div class="login-form">
            <el-form :model="loginForm" status-icon :rules="rules" ref="form">
                <el-form-item label="充值金额" prop="money" label-width="100px">
        ...
        <div slot="footer" class="dialog-footer">
            ...
            <el-button type="primary">提 现</el-button>
        </div>
    </el-dialog>
</template>
<script>
